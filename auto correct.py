from textblob import TextBlob   ##### for installing library use this command :  pip install textblob
from tkinter import *
...
root.resizable(0,0)
root.title("Project--  Auto Spelling Correction   - Code Punk")
root.config(bg = 'blue')
...
#footer
Label(root,text ="Developed By Code Punk", font = 'arial 20 bold', pady=5,bg ='white smoke' , width = '20').pack(side = 'bottom')
